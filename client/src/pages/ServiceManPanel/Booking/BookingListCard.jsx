...
const BookingListCard = ({ handlePagination, handleBookingAccept, handleBookingStartOtp }) => {
                    ...
                    <div className="card-body d-md-flex align-items-center">
                        <div className="booking-widget d-sm-flex align-items-center row-gap-3 flex-fill  mb-3 mb-md-0">
                            ...
                            <div className="booking-det-info">
                                <h6 className="mb-3">
                                    <Link to={'booking/' + value._id}>{value.booking.bookingId}</Link>
                        ...
                        <div>
                                ...
                                <Link
                                    ...
                                    onClick={() => handleBookingAccept(value._id)}
                                >
                                    Accept
                                </Link>
                                ...
                                <Link
                                    ...
                                    onClick={() => handleBookingStartOtp(value._id)}
                                >
                                    Start Booking
                                </Link>
