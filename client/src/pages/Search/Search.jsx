            ...
            <div className="col-xl-9 col-lg-8">
              <div className="d-flex justify-content-between align-items-center flex-wrap mb-4">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <Link to="/javascript:void(0);" className="tags d-flex justify-content-center align-items-center bg-primary rounded me-2"><i className="ti ti-layout-grid" /></Link>
                  <Link to="/javascript:void(0);" className="tags d-flex justify-content-center align-items-center border rounded"><i className="ti ti-list" /></Link>
                </div>
              </div>
                    ...
                    <div className="card-body p-0">
                      ...
                      <div className="p-3">
                        <h5 className="mb-2 text-truncate">
                          <Link to="/javascript:void(0);">Computer Hardware Service</Link>
                        </h5>
                        <div className="d-flex justify-content-between align-items-center mb-3">
