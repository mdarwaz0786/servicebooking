  ...
  return (
    <div className="col-xl-9 col-lg-8">
      <div className="d-flex justify-content-between align-items-center flex-wrap mb-4">
        <h4>Wallet</h4>
        <div>
          <a href="javascript:void(0);" className="btn btn-dark btn-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add-wallet"><i className="ti ti-square-rounded-plus me-1" />Add
            Wallet</a>
        </div>
      </div>
      <div className="row">
        <div className="col-lg col-md-3">
          <div className="card p-3">
            <div className="d-flex align-items-center">
              <div className="me-3">
                <span className="wallet-icon bg-gray rounded-circle d-flex align-items-center justify-content-center"><i className="ti ti-wallet" /></span>
              </div>
              <div>
            ...
            <table className="table mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <p className="text-gray fs-14">07 Oct 2022 11:22:51 </p>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <p className="text-gray fs-14">06 Oct 2022 11:22:51 </p>
                  </td>
                  <td>
                    <p className="fs-14">Paypal</p>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <p className="text-gray fs-14">28 Sep 2022 11:22:51 </p>
                  </td>
                  <td>
                    <p className="fs-14">Paypal</p>
                  </td>
