  ...
  return (
    <>
      <Helmet>
        ...
        {/* CANONICAL URL */}
        <link rel="canonical" href={data?.canonicalTag || canonicalUrl} />
        ...
        {data?.lat && data?.long && (
          <>
            ...
            <meta name="business:hours" content={data?.work_hours || "9:00 AM - 8:00 PM"} />
            ...
            {data?.zipCode && <meta name="postal-code" content={data?.zipCode} />}
          </>
        )}
        ...
        <meta property="og:site_name" content={data?.site_name || appName} />
