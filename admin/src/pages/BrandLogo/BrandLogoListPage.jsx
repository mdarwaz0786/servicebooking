...
const BrandLogoListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.brandLogo.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.brandLogo.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
                      ...
                      <tr key={d?._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-brand-logo/${d?._id}`}>
...
export default BrandLogoListPage;
