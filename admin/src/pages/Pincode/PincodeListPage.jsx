...
const PincodeListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.pincode.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.pincode.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
      if (response?.data?.success) {
