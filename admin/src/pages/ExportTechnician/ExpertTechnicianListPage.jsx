...
const ExpertTechnicianListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.expertTechnician.get, {
  ...
  const toggleStatus = async (id, currentStatus) => {
    ...
    try {
      const response = await axios.patch(
        `${apis.expertTechnician.update}/${id}`,
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.expertTechnician.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
    ...
    <div className="page-wrapper page-settings">
      <div className="content">
        <div className="content-page-header content-page-headersplit mb-0 d-flex align-items-center justify-content-between">
          <h5>Expert Technician {data?.length}</h5>
                      ...
                      <tr key={d?._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-expert-technician/${d?._id}`}>
...
export default ExpertTechnicianListPage;
