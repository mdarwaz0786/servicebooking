...
const ProductStoreFormPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(apis.brand.get, {
  ...
  useEffect(() => {
    if (id) {
      const fetchData = async () => {
        try {
          const res = await axios.get(`${apis.productStore.get}/${id}`, {
            headers: { Authorization: validToken },
          });
          if (res.data.success) {
            setFormData({
              ...
              partType: res.data.data.partType || "",
              brandId: res.data.data.brandId?._id || "",
            });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let res;
      if (id) {
        res = await axios.patch(`${apis.productStore.update}/${id}`, data, {
          headers: { Authorization: validToken, "Content-Type": "multipart/form-data" },
        });
      } else {
        res = await axios.post(apis.productStore.create, data, {
          headers: { Authorization: validToken, "Content-Type": "multipart/form-data" },
        });
      }
...
export default ProductStoreFormPage;
