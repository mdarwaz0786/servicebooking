...
const ProductStoreListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.productStore.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.productStore.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
      if (response?.data?.success) {
    ...
    <div className="page-wrapper page-settings">
      <div className="content">
        <div className="content-page-header content-page-headersplit mb-0 d-flex align-items-center justify-content-between">
          <h5>Product Store {data?.length}</h5>
                      ...
                      <tr key={d._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-product-store/${d._id}`}>
...
export default ProductStoreListPage;
