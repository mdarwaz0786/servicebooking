...
const TrainingAttendanceListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.trainingAttendance.get, {
    ...
    <div className="page-wrapper page-settings">
      <div className="content">
        <div className="content-page-header content-page-headersplit mb-0 d-flex align-items-center justify-content-between">
          <h5>Training Attendance {data?.length}</h5>
          <div className="d-flex gap-2 align-items-center">
            ...
            <Link to="/add-training-attendance">
...
export default TrainingAttendanceListPage;

// import React from 'react'

// const TrainingAttendanceListPage = () => {
//   return (
//     <div>TrainingAttendanceListPage</div>
//   )
// }
