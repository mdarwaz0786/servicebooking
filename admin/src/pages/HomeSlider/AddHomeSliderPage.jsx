        ...
        <div className="card">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                <label className="form-label">Slider Image <span className="text-danger">*</span></label>
                ...
                {preview && <div className="mt-3 text-center"><img src={preview} alt="Slider Preview" style={{ maxWidth: "300px", borderRadius: "8px" }} /></div>}
              </div>
