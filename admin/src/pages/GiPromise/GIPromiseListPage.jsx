...
const GIPromiseListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.giPromise.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.giPromise.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
                      ...
                      <tr key={d?._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-gi-promise/${d?._id}`}>
...
export default GIPromiseListPage;
