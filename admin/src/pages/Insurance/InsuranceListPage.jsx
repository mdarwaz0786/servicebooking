...
const InsuranceListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.insurance.get, {
        headers: { Authorization: validToken },
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.insurance.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
      if (response?.data?.success) {
                      ...
                      <tr key={d._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-insurance/${d._id}`}>
