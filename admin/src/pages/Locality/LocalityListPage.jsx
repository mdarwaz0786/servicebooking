...
const LocalityListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.locality.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.locality.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
      if (response?.data?.success) {
