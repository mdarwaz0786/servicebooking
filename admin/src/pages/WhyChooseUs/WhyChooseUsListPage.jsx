...
const WhyChooseUsListPage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(apis.whyChooseUs.get, {
  ...
  const deleteData = async (id) => {
    ...
    try {
      const response = await axios.delete(`${apis.whyChooseUs.delete}/${id}`, {
        headers: { Authorization: validToken },
      });
    ...
    <div className="page-wrapper page-settings">
      <div className="content">
        <div className="content-page-header content-page-headersplit mb-0 d-flex align-items-center justify-content-between">
          <h5>Why Choose Us {data?.length}</h5>
                      ...
                      <tr key={d?._id}>
                        ...
                        <td>
                          <div className="d-flex">
                            <Link to={`/update-why-choose-us/${d?._id}`}>
...
export default WhyChooseUsListPage;
