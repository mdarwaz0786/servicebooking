const permissionMap = {
  ...
  // ================= PROVIDER WALLET =================
  "POST /api/v1/admin/provider-wallet": { module: "providerWallet", action: "add" },
  "GET /api/v1/admin/provider-wallet": { module: "providerWallet", action: "view" },
  "GET /api/v1/admin/provider-wallet/:id": { module: "providerWallet", action: "view" },
  "PUT /api/v1/admin/provider-wallet/:id": { module: "providerWallet", action: "update" },
  "PATCH /api/v1/admin/provider-wallet/:id": { module: "providerWallet", action: "update" },
  "DELETE /api/v1/admin/provider-wallet/:id": { module: "providerWallet", action: "delete" },

  // ================= PROVIDER CASH COLLECTED =================
  "POST /api/v1/admin/provider-cash-collected": { module: "providerCashcollected", action: "add" },
  "GET /api/v1/admin/provider-cash-collected": { module: "providerCashcollected", action: "view" },
  "GET /api/v1/admin/provider-cash-collected/:id": { module: "providerCashcollected", action: "view" },
  "PUT /api/v1/admin/provider-cash-collected/:id": { module: "providerCashcollected", action: "update" },
  "PATCH /api/v1/admin/provider-cash-collected/:id": { module: "providerCashcollected", action: "update" },
  "DELETE /api/v1/admin/provider-cash-collected/:id": { module: "providerCashcollected", action: "delete" },

  // ================= PROVIDER CASH SUBMIT =================
  "POST /api/v1/admin/provider-cash-submit": { module: "providerCashSubmit", action: "add" },
  "GET /api/v1/admin/provider-cash-submit": { module: "providerCashSubmit", action: "view" },
  "GET /api/v1/admin/provider-cash-submit/:id": { module: "providerCashSubmit", action: "view" },
  "PUT /api/v1/admin/provider-cash-submit/:id": { module: "providerCashSubmit", action: "update" },
  "PATCH /api/v1/admin/provider-cash-submit/:id": { module: "providerCashSubmit", action: "update" },
  "DELETE /api/v1/admin/provider-cash-submit/:id": { module: "providerCashSubmit", action: "delete" },

  // ================= PROVIDER INSURANCE =================
  "POST /api/v1/admin/provider-insurance": { module: "providerInsurance", action: "add" },
  "GET /api/v1/admin/provider-insurance": { module: "providerInsurance", action: "view" },
  "GET /api/v1/admin/provider-insurance/:id": { module: "providerInsurance", action: "view" },
  "PUT /api/v1/admin/provider-insurance/:id": { module: "providerInsurance", action: "update" },
  "PATCH /api/v1/admin/provider-insurance/:id": { module: "providerInsurance", action: "update" },
  "DELETE /api/v1/admin/provider-insurance/:id": { module: "providerInsurance", action: "delete" },
  ...
  "POST /api/v1/admin/provider-notification": { module: "providerNotification", action: "add" },
  "GET /api/v1/admin/provider-notification": { module: "providerNotification", action: "view" },
  "GET /api/v1/admin/provider-notification/:id": { module: "providerNotification", action: "view" },
  "PUT /api/v1/admin/provider-notification/:id": { module: "providerNotification", action: "update" },
  "PATCH /api/v1/admin/provider-notification/:id": { module: "providerNotification", action: "update" },
  "DELETE /api/v1/admin/provider-notification/:id": { module: "providerNotification", action: "delete" },

  // ================= ACTIVE BOOKING =================
  "POST /api/v1/admin/active-booking": { module: "activeBooking", action: "add" },
  "GET /api/v1/admin/active-booking": { module: "activeBooking", action: "view" },
  "GET /api/v1/admin/active-booking/:id": { module: "activeBooking", action: "view" },
  "PUT /api/v1/admin/active-booking/:id": { module: "activeBooking", action: "update" },
  "PATCH /api/v1/admin/active-booking/:id": { module: "activeBooking", action: "update" },
  "DELETE /api/v1/admin/active-booking/:id": { module: "activeBooking", action: "delete" },

  // ================= CANCEL BOOKING =================
  "POST /api/v1/admin/cancel-booking": { module: "cancelBooking", action: "add" },
  "GET /api/v1/admin/cancel-booking": { module: "cancelBooking", action: "view" },
  "GET /api/v1/admin/cancel-booking/:id": { module: "cancelBooking", action: "view" },
  "PUT /api/v1/admin/cancel-booking/:id": { module: "cancelBooking", action: "update" },
  "PATCH /api/v1/admin/cancel-booking/:id": { module: "cancelBooking", action: "update" },
  "DELETE /api/v1/admin/cancel-booking/:id": { module: "cancelBooking", action: "delete" },

  // ================= COMPLETE BOOKING =================
  "POST /api/v1/admin/complete-booking": { module: "completeBooking", action: "add" },
  "GET /api/v1/admin/complete-booking": { module: "completeBooking", action: "view" },
  "GET /api/v1/admin/complete-booking/:id": { module: "completeBooking", action: "view" },
  "PUT /api/v1/admin/complete-booking/:id": { module: "completeBooking", action: "update" },
  "PATCH /api/v1/admin/complete-booking/:id": { module: "completeBooking", action: "update" },
  "DELETE /api/v1/admin/complete-booking/:id": { module: "completeBooking", action: "delete" },

  // ================= CUSTOMER PAYMENT =================
  "POST /api/v1/admin/customer-payment": { module: "customerPayment", action: "add" },
  "GET /api/v1/admin/customer-payment": { module: "customerPayment", action: "view" },
  "GET /api/v1/admin/customer-payment/:id": { module: "customerPayment", action: "view" },
  "PUT /api/v1/admin/customer-payment/:id": { module: "customerPayment", action: "update" },
  "PATCH /api/v1/admin/customer-payment/:id": { module: "customerPayment", action: "update" },
  "DELETE /api/v1/admin/customer-payment/:id": { module: "customerPayment", action: "delete" },

  // ================= PROVIDER PAYMENT =================
  "POST /api/v1/admin/provider-payment": { module: "providerPayment", action: "add" },
  "GET /api/v1/admin/provider-payment": { module: "providerPayment", action: "view" },
  "GET /api/v1/admin/provider-payment/:id": { module: "providerPayment", action: "view" },
  "PUT /api/v1/admin/provider-payment/:id": { module: "providerPayment", action: "update" },
  "PATCH /api/v1/admin/provider-payment/:id": { module: "providerPayment", action: "update" },
  "DELETE /api/v1/admin/provider-payment/:id": { module: "providerPayment", action: "delete" },
  ...
  // ================= WIDE BANNER =================
  "POST /api/v1/admin/wide-banner": { module: "wideBanner", action: "add" },
  "GET /api/v1/admin/wide-banner": { module: "wideBanner", action: "view" },
  "GET /api/v1/admin/wide-banner/:id": { module: "wideBanner", action: "view" },
  "PUT /api/v1/admin/wide-banner/:id": { module: "wideBanner", action: "update" },
  "PATCH /api/v1/admin/wide-banner/:id": { module: "wideBanner", action: "update" },
  "DELETE /api/v1/admin/wide-banner/:id": { module: "wideBanner", action: "delete" },

  // ================= PRODUCT SERVICE =================
  "POST /api/v1/admin/product-service": { module: "productService", action: "add" },
  "GET /api/v1/admin/product-service": { module: "productService", action: "view" },
  "GET /api/v1/admin/product-service/:id": { module: "productService", action: "view" },
  "PUT /api/v1/admin/product-service/:id": { module: "productService", action: "update" },
  "PATCH /api/v1/admin/product-service/:id": { module: "productService", action: "update" },
  "DELETE /api/v1/admin/product-service/:id": { module: "productService", action: "delete" },

  // ================= FRONT BANNER =================
  "POST /api/v1/admin/front-banner": { module: "frontBanner", action: "add" },
  "GET /api/v1/admin/front-banner": { module: "frontBanner", action: "view" },
  "GET /api/v1/admin/front-banner/:id": { module: "frontBanner", action: "view" },
  "PUT /api/v1/admin/front-banner/:id": { module: "frontBanner", action: "update" },
  "PATCH /api/v1/admin/front-banner/:id": { module: "frontBanner", action: "update" },
  "DELETE /api/v1/admin/front-banner/:id": { module: "frontBanner", action: "delete" },

  // ================= GI IMPACT =================
  "POST /api/v1/admin/gi-impact": { module: "giImpact", action: "add" },
  "GET /api/v1/admin/gi-impact": { module: "giImpact", action: "view" },
  "GET /api/v1/admin/gi-impact/:id": { module: "giImpact", action: "view" },
  "PUT /api/v1/admin/gi-impact/:id": { module: "giImpact", action: "update" },
  "PATCH /api/v1/admin/gi-impact/:id": { module: "giImpact", action: "update" },
  "DELETE /api/v1/admin/gi-impact/:id": { module: "giImpact", action: "delete" },
  ...
  // ================= JOB =================
  "POST /api/v1/admin/job": { module: "job", action: "add" },
  "GET /api/v1/admin/job": { module: "job", action: "view" },
  "GET /api/v1/admin/job/:id": { module: "job", action: "view" },
  "PUT /api/v1/admin/job/:id": { module: "job", action: "update" },
  "PATCH /api/v1/admin/job/:id": { module: "job", action: "update" },
  "DELETE /api/v1/admin/job/:id": { module: "job", action: "delete" },

  // ================= RESUME =================
  "POST /api/v1/admin/resume": { module: "resume", action: "add" },
  "GET /api/v1/admin/resume": { module: "resume", action: "view" },
  "GET /api/v1/admin/resume/:id": { module: "resume", action: "view" },
  "PUT /api/v1/admin/resume/:id": { module: "resume", action: "update" },
  "PATCH /api/v1/admin/resume/:id": { module: "resume", action: "update" },
  "DELETE /api/v1/admin/resume/:id": { module: "resume", action: "delete" },

  // ================= CUSTOMER SUPPORT =================
  "POST /api/v1/admin/customer-support": { module: "customerSupport", action: "add" },
  "GET /api/v1/admin/customer-support": { module: "customerSupport", action: "view" },
  "GET /api/v1/admin/customer-support/:id": { module: "customerSupport", action: "view" },
  "PUT /api/v1/admin/customer-support/:id": { module: "customerSupport", action: "update" },
  "PATCH /api/v1/admin/customer-support/:id": { module: "customerSupport", action: "update" },
  "DELETE /api/v1/admin/customer-support/:id": { module: "customerSupport", action: "delete" },

  // ================= PROVIDER SUPPORT =================
  "POST /api/v1/admin/provider-support": { module: "providerSupport", action: "add" },
  "GET /api/v1/admin/provider-support": { module: "providerSupport", action: "view" },
  "GET /api/v1/admin/provider-support/:id": { module: "providerSupport", action: "view" },
  "PUT /api/v1/admin/provider-support/:id": { module: "providerSupport", action: "update" },
  "PATCH /api/v1/admin/provider-support/:id": { module: "providerSupport", action: "update" },
  "DELETE /api/v1/admin/provider-support/:id": { module: "providerSupport", action: "delete" },
